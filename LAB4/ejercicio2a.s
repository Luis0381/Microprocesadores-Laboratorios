...
reset:
    ...
    BL inicializarTimer
    BL configurarInterrupcionTimer
    //--------
...
actualizarHora:
    ...
    MOV R0,#1   //ESTABLEZCO EN 0 R0 

    //Actualizacion horas
    //Recibe en R0 si debe incrementar segundos y en R1 la direccion de los segundos
    LDR R1,=segundos
    BL incrementarSegundosYMinutos //Devuelve en R0 si hay desbordamiento de segundos
    LDR R1,=hora
    BL incrementarSegundosYMinutos //Devuelve en R0 si hay desbordamiento de minutos
    LDR R1,=hora
