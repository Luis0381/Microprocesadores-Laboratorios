/*b) Se desea cambiar el comportamiento del temporizador para que el contador registre la
cantidad de segundos transcurridos desde el inicio del día. Para ello el mismo se debe
reiniciar cuando la cuenta alcance el valor de 60 * 60 * 24 = 86.400 segundos. Modifique
el programa anterior para que la cuenta se realice de esta manera y la hora, minutos y
segundos actuales se obtengan del valor actual del contador. */
...
.func conversion
conversion:
    //R0 direccion memoria donde esta num natural
...
inicializarTimer:
    ...
    // Prescaler de 9.500.000 para una frecuencia de 1 Hz
    LDR R0,=95000000 //POr ahi lo pongo en menos para probar el reloj
    STR R0,[R1,#PR]
    //----------------------
