...
.section .isr // Define una seccion especial para el vector
    ...
    .word 0 // 9: Reserved// Recursos utilizados por la primera tecla
    .equ TEC_1_PORT,    4
    .equ TEC_1_PIN,     8
    .equ TEC_1_BIT,     12
    .equ TEC_1_MASK,    (1 << TEC_1_BIT)
...
// Recursos utilizados por el teclado
    .equ TEC_GPIO,      5
    .equ TEC_MASK,      (TEC_1_MASK | TEC_2_MASK)entry
    .word 0 // 10: Reserve// Recursos utilizados por la primera tecla
    .equ TEC_1_PORT,    4
    .equ TEC_1_PIN,     8
    .equ TEC_1_BIT,     12
    .equ TEC_1_MASK,    (1 << TEC_1_BIT)
...
// Recursos utilizados por el teclado
    .equ TEC_GPIO,      5
    .equ TEC_MASK,      (TEC_1_MASK | TEC_2_MASK) entry
    .word handler+1 // 11:// Recursos utilizados por la primera tecla
    .equ TEC_1_PORT,    4
    .equ TEC_1_PIN,     8
    .equ TEC_1_BIT,     12
    .equ TEC_1_MASK,    (1 << TEC_1_BIT)
...
// Recursos utilizados por el teclado
    .equ TEC_GPIO,      5
    .equ TEC_MASK,      (TEC_1_MASK | TEC_2_MASK)System service call trap service routine
    .word 0 // 12: Reserve// Recursos utilizados por la primera tecla
    .equ TEC_1_PORT,    4
    .equ TEC_1_PIN,     8
    .equ TEC_1_BIT,     12
    .equ TEC_1_MASK,    (1 << TEC_1_BIT)
...
// Recursos utilizados por el teclado
    ...
    .word handler+1 // 15: Sy// Recursos utilizados por la primera tecla
    .equ TEC_1_PORT,    4
    .equ TEC_1_PIN,     8
    .equ TEC_1_BIT,     12
    .equ TEC_1_MASK,    (1 << TEC_1_BIT)
...
// Recursos utilizados por el teclado
    .equ TEC_GPIO,      5
    .equ TEC_MASK,      (TEC_1_MASK | TEC_2_MASK)tem tick service routine
    .word handler+1 // 16: IR// Recursos utilizados por la primera tecla
    .equ TEC_1_PORT,    4
    .equ TEC_1_PIN,     8
    .equ TEC_1_BIT,     12
    .equ TEC_1_MASK,    (1 << TEC_1_BIT)
...
// Recursos utilizados por el teclado
    .equ TEC_GPIO,      5
    .equ TEC_MASK,      (TEC_1_MASK | TEC_2_MASK) 0: DAC service routine
...
tecla1:
    ...
    CMP R1, #90
    BEQ tecla2
    ADD R1, #10      //aumenta ciclo del duty
