...
timer_isr:
    ...
    MOVNE R3,R2
    ADDNE R2,#1 //Sumo uno al factor de trabajo para que la proxima que se apague ya la duracion del periodo apagado sea menos 
                // y la duracion del periodo encendido sea el nuevo duty factor y se suma 1 al duty actual para que en la proxima vuelva a variar
    ...
    //Establezco como cota de factor maximo 180 para el duty factor
    CMP R2,180
    IT EQ
    MOVEQ R2,#10
